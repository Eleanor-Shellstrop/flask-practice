...
class HashTable:
    """This wouldn't be a good use for real-life scenarios,
    but for the purpose of this exercise, the hash table 
    will be fine for demoing"""
